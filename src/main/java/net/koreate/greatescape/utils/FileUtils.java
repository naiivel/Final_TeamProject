...
public class FileUtils {
  public static String uploadFile(String realPath, MultipartFile file) throws Exception {
    ...
    if (MediaUtils.getMediaType(formatName) != null) {
      uploadFileName = makeThumdnail(realPath, datePath, savedName);
    } else {
  ...
  private static String makeThumdnail(String realPath, String datePath, String savedName) throws IOException {
    String name = "";
    ...
    BufferedImage sourceImage = 
      Scalr.resize(image, 
        ...
        100, new java.awt.image.BufferedImageOp[0]);
    String thumbnailImage = 
      String.valueOf(realPath) + datePath + File.separator + "s_" + savedName;
  ...
  public static String calcPath(String realPath) {
    ...
    datePath = String.valueOf(monthPath) + File.separator + (
      new DecimalFormat("00")).format(cal.get(5));
